...
def train_gp(train_x, train_y, use_ard, num_steps, kern='transformed_overlap', hypers={},
             ...
             num_mixtures1=5, num_mixtures2=4,
             **params):
    ...
    if kern == 'overlap':
        ...
        kernel = MixtureKernel(cat_dims, cont_dims,
                               ...
                               integer_dims=int_constrained_dims, continuous_kern_type = continuous_kern_type,
                               num_mixtures1=num_mixtures1, num_mixtures2=num_mixtures2,
                               **params)
...
def random_sample_within_discrete_tr_ordinal(x_center, max_hamming_dist, n_categories):
    """Same as above, but here we assume an ordinal representation of the categorical variables."""
    # random.seed(random.randint(0, 1e6))
